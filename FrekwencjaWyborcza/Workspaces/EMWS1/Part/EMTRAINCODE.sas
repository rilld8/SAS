...
length _Pformat1 $58;
drop _Pformat1;
_Pformat1 = strip(put(vote, V26_F.));
if
_Pformat1 = 'Yes'
then do;
if (2344+1-_C000004)*_genvalue_ <= (1406 - _C000001) then do;
_C000001 + 1;
output EMWS1.Part_TRAIN;
end;
else do;
if (2344+1-_C000004)*_genvalue_ <= (1406 - _C000001 + 469 - _C000002) then do;
_C000002 + 1;
...
_Pformat1 = 'No'
then do;
if (462+1-_C000008)*_genvalue_ <= (277 - _C000005) then do;
_C000005 + 1;
output EMWS1.Part_TRAIN;
end;
else do;
if (462+1-_C000008)*_genvalue_ <= (277 - _C000005 + 92 - _C000006) then do;
_C000006 + 1;
output EMWS1.Part_VALIDATE;
end;
else do;
